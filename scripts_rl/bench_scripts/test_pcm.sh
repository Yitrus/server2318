...
while :
do
    /home/xmu/Documents/yi/tools/pcm-202403/build/bin/pcm-power -p -1 | grep -e Consumed >> ./power.txt & 
    sleep 2
    ...
    /home/xmu/Documents/yi/tools/pcm-202403/build/bin/pcm-memory | grep -e NODE >> ./bw.txt &
    sleep 2
    pgrep -f "pcm"| xargs ps -fp
    echo "------------------------------------"
    pgrep -f "/home/xmu/Documents/yi/tools/pcm-202403/build/bin/pcm-power -p -1"
