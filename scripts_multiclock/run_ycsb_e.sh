...
BENCH_RUN="numactl --cpunodebind=0 ${BIN}/bin/ycsb run memcached -s -P ${BIN}/workloads/workloade -p "memcached.hosts=127.0.0.1" -p "memcached.port=11211" -p recordcount=1000000000 -p operationcount=250000000 -threads 112"
BENCH_NAME="ycsb_e"
DATE=""
VER=""
PID=""
