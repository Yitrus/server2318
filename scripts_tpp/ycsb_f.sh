...
BENCH_RUN="numactl --membind=0,2 ${BIN}/bin/ycsb run memcached -s -P ${BIN}/workloads/workloadf -p "memcached.hosts=127.0.0.1" -p "memcached.port=11211" -p recordcount=1000000000 -p operationcount=125000000 -threads 112"
BENCH_NAME="ycsb_f"
DATE=""
VER=""
PID=""
