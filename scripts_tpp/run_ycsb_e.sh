...
BENCH_RUN="numactl --membind=0,2 ${BIN}/bin/ycsb run memcached -s -P ${BIN}/workloads/workloade -p "memcached.hosts=127.0.0.1" -p "memcached.port=11211" -p recordcount=250000000 -p operationcount=250000000 -threads 64"
BENCH_NAME="ycsb_e"
DATE=""
VER=""
PID=""
