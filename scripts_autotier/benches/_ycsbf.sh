...
# case ${BENCH_SIZE} in
#     "kdd12")
        BENCH_RUN+="${BENCH_BIN}/bin/ycsb run memcached -s -P ${BENCH_BIN}/workloads/workloadf -p "memcached.hosts=127.0.0.1" -p "memcached.port=11211" -p recordcount=1000000000 -p operationcount=125000000 -threads 112"
    #     ;;
    # *)
